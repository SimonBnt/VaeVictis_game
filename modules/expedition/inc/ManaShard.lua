...
local manaShardsByClass = {
    ...
    b = Item:new("Greater Mana Shard", "A strong shard pulsating with magical power.", 0.5, false),
    a = Item:new("Overflowing Mana Shard", "So much magic leaks from it, the air trembles nearby.", 0.6, false),
    s = Item:new("Pure Mana", "A crystallized essence of pure, untainted mana. Extremely rare.", 0.7, false)
}
